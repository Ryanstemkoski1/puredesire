...
const WorkbookList = () => {
    ...
    useEffect(() => {
        axios
            .get(process.env.REACT_APP_API_URL + "/workbook/")
            .then(({ data }) => {
                setWorkbooks(data);
    ...
    const DataTable = () => {
        return workbooks.map((res, i) => {
            return <WorkbookTableRow obj={res} key={i} />;
        });
    };
                ...
                <React.Fragment>
                    <Grid container
                        ...
                        <Grid item xs={12} lg="auto">
                            <Link href="/workbook/create-workbook" className="button-link">Create New Workbook</Link>
                        </Grid>
                    </Grid>
                    <div>
                        <Accordion>
