...
const mongoUser = 'puredesire';
const mongoDbName = 'test';
const mongoPass = 'HjPTTQuiGIjPa8Ol';
const mongoConnStr = `mongodb+srv://${mongoUser}:${mongoPass}@puredesire.aaufor2.mongodb.net/${mongoDbName}?retryWrites=true`;
